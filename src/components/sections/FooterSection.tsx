  ...
  return (
    <footer className="relative bg-[#111] text-[#E4E2D8] pt-0 pb-8">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto">
        ...
        {/* Main footer columns: 4 equal columns */}
        <div className="grid grid-cols-1 md:[grid-template-columns:repeat(4,minmax(0,1fr))] gap-0 mb-12 px-0 relative after:absolute after:bottom-0 after:left-0 after:right-0 after:h-px after:bg-white/[0.08] [&>*:not(:last-child)]:border-b [&>*:not(:last-child)]:md:border-b-0 [&>*:not(:last-child)]:border-white/[0.08]">
          ...
          <div className="py-8 md:py-10 px-6 md:border-r md:border-white/[0.08]">
            <Link href="/" className="inline-flex items-center mb-4" aria-label="Vista home">
              <BrandLogo
                variant="lockup"
                theme="dark"
                className="w-[80px] h-auto max-w-none shrink-0"
              />
            </Link>
          ...
          {/* Pages (1fr) */}
          <div className="py-8 md:py-10 px-6 md:border-r md:border-white/[0.08]">
            <h3 className="text-xs uppercase tracking-[0.12em] text-white/50 mb-3 font-mono">Pages</h3>
            <ul className="space-y-2">
              <li><Link href="/" className="text-sm text-white/70 hover:text-[#FF5233] transition-colors">Home</Link></li>
              <li><Link href="/#latest" className="text-sm text-white/70 hover:text-[#FF5233] transition-colors">Blog</Link></li>
              <li><Link href="/#services" className="text-sm text-white/70 hover:text-[#FF5233] transition-colors">Services</Link></li>
              <li><Link href="/about" className="text-sm text-white/70 hover:text-[#FF5233] transition-colors">About</Link></li>
            </ul>
          </div>
