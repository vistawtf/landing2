...
export function NewsletterSection() {
  return (
    <section id="newsletter" className="py-24 md:py-32 border-t border-border">
      <div className="container">
        <AnimatedSection delay={150}>
          <div className="newsletter-hero-card relative isolate flex w-full min-h-[270px] items-start overflow-hidden border border-[#d4d4d4] bg-[#f7f7f7] px-[clamp(18px,3vw,26px)] py-[clamp(28px,3.9vw,40px)] max-md:pb-[18px] md:min-h-[clamp(500px,50vh,580px)] md:py-[clamp(40px,4.8vw,58px)] md:px-[clamp(24px,2.8vw,36px)] md:items-center">
            ...
            <div
              ...
              aria-hidden="true"
            />
            <div className="newsletter-hero-overlay absolute inset-0" aria-hidden="true" />
            ...
            <div className="newsletter-hero-content relative z-10 w-full">
              <div className="newsletter-hero-layout">
                ...
                <div className="newsletter-hero-form-wrap">
                  ...
                  >
                    <input
                      ...
                      required
                    />
                    <button type="submit" className="newsletter-hero-submit" aria-label="Subscribe">
                      <span>SUBSCRIBE</span>
                ...
                <div className="newsletter-hero-partners" aria-label="Newsletter partners">
                  <div className="newsletter-partner-strip" role="group">
                    <a href="https://ethlatam.org" target="_blank" rel="noopener noreferrer" className="newsletter-partner-link newsletter-partner-logo newsletter-partner-logo-eth">
                      <Image src="/partners/eth-latam-black.svg" alt="ETH Latam" width={1408} height={710} className="newsletter-partner-image newsletter-partner-image-light" />
                      <Image src="/partners/eth-latam-white.svg" alt="ETH Latam" width={1408} height={710} className="newsletter-partner-image newsletter-partner-image-dark" />
                    </a>
                    <a href="https://arco.lat" target="_blank" rel="noopener noreferrer" className="newsletter-partner-link newsletter-partner-logo newsletter-partner-logo-arco">
                      <Image src="/partners/arco-black.png" alt="Arco Latam Studio" width={780} height={485} className="newsletter-partner-image newsletter-partner-image-light" />
                      <Image src="/partners/arco-white.png" alt="Arco Latam Studio" width={780} height={485} className="newsletter-partner-image newsletter-partner-image-dark" />
                    </a>
                  </div>
                </div>
              </div>
