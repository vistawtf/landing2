            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <AnimatedSection delay={100} className="lg:col-span-2">
                ...
                <div className="flex items-center gap-4 mt-8">
                  ...
                  <a href="https://twitter.com/viaboratorio" target="_blank" rel="noopener noreferrer" className="p-2 text-muted hover:text-ultra-orange transition-colors" aria-label="Twitter">
